  ...
  return useCallback(
    async (rawText: string, options?: SubmitTextOptions) => {
      ...
      try {
        ...
        // A send that raced a not-yet-settled turn gets a transient
        // "session busy" (4009). Don't surface an error bubble/toast — callers
        // can queue/retry from the composer layer when appropriate.
