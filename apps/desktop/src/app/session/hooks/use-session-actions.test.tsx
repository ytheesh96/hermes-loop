...
describe('resumeSession warm-cache mapping integrity', () => {
  ...
  it('honours a warm cache entry whose stored id matches and refreshes its persisted transcript', async () => {
    ...
    // Fork profile routing falls back to the window profile for rows without an
    // explicit profile; the neutral window is represented as null.
    expect(getSessionMessages).toHaveBeenCalledWith('stored-A', null)
