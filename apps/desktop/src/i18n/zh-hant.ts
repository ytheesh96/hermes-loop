...
export const zhHant = defineLocale({
  ...
  titlebar: {
    ...
    hideRightSidebar: '隱藏檔案側邊欄',
    showRightSidebar: '顯示檔案側邊欄',
    muteHaptics: '靜音觸感回饋',
  ...
  liveGraph: {
    ...
    title: '圖譜檢視',
    open: '開啟圖譜檢視',
    subtitle: (nodes, edges) => `${nodes} 個節點 · ${edges} 條連線`,
    searchPlaceholder: '搜尋圖譜…',
    fit: '配合圖譜',
    arrows: '箭頭',
    labels: '標籤',
    nodeSize: '節點大小',
    textFadeThreshold: '文字淡化閾值',
    orphans: '孤立節點',
    focusDepth: '聚焦深度',
    depthOne: '1 跳',
    depthTwo: '2 跳',
    ...
    linkDistance: '連線距離',
    animate: '動畫',
    emptyTitle: '此工作階段目前安靜',
    emptyDesc: 'Hermes 工作時，工作流程、代理與產出會顯示在這裡。',
    loading: '正在載入工作階段圖譜…',
    loadFailed: '無法載入工作階段圖譜。',
    globalTitle: '所有工作流程',
    globalEmptyTitle: '尚無工作流程',
    globalEmptyDesc: 'Hermes 建立的各工作階段工作流程會顯示在這裡。',
    globalLoading: '正在載入工作流程圖譜…',
    globalLoadFailed: '無法載入工作流程圖譜。',
    openSession: '開啟工作階段',
    unattachedWorkflows: '未連結的工作流程',
    noMatches: '沒有相符的節點。',
    inspector: '所選項目',
    taskId: '任務 ID',
    assignee: '負責人',
    ...
    taskDetailLoading: '正在載入任務詳細資料…',
    taskDetailLoadFailed: '無法載入最新任務詳細資料。',
    taskCommentsEmpty: '尚無留言。',
    taskCommentComposerLabel: '為此任務新增留言',
    taskCommentPlaceholder: '新增留言…',
    taskCommentSubmit: '留言',
    taskCommentSubmitting: '正在發佈…',
    taskCommentSubmitFailed: '無法發佈留言，請再試一次。',
    taskActivityEmpty: '尚無活動。',
    taskWorkerTranscriptLoading: '正在載入工作階段活動…',
    taskWorkerTranscriptLoadFailed: '無法載入工作階段活動。',
    taskWorkerTranscriptEmpty: '尚無工作階段活動。',
    taskRunHistory: '執行歷程',
    ...
    tasksTab: '任務',
    messagesTab: '訊息',
    messagesLoading: '正在載入訊息…',
    messagesEmpty: '尚無任務留言。',
    messagesLoadFailed: '無法載入任務訊息。',
    messagesStale: '正在顯示上次完整內容。重新整理失敗。',
  ...
  statusStack: {
    ...
    blockedTasks: count => `${count} 個受阻任務`,
    completedTasks: count => `${count} 個已完成任務`,
    loop: 'Loop',
    loopWorkers: count => `${count} 個 Kanban 代理`,
    pendingTasks: count => `${count} 個待處理任務`,
    newWorkflow: '新增工作流程',
    openWorkflow: '開啟工作流程',
    goalActive: '目標進行中',
    goalDone: '目標已完成',
