...
export const zhHant = defineLocale({
  ...
  liveGraph: {
    ...
    taskWorkerTranscript: '工作程序記錄',
    taskWorkerTranscriptLoading: '正在載入工作程序記錄…',
    taskWorkerTranscriptLoadFailed: '無法載入工作程序記錄。',
    taskWorkerTranscriptEmpty: '尚無工作程序記錄。',
    taskTranscriptUser: '使用者',
    taskTranscriptWorker: '工作程序',
    taskTranscriptTool: '工具',
    taskRunHistory: '執行歷程',
