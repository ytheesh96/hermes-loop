...
export const en: Translations = {
  ...
  liveGraph: {
    ...
    taskWorkerTranscript: 'Worker transcript',
    taskWorkerTranscriptLoading: 'Loading worker transcript…',
    taskWorkerTranscriptLoadFailed: 'Could not load the worker transcript.',
    taskWorkerTranscriptEmpty: 'No worker transcript is available.',
    taskTranscriptUser: 'User',
    taskTranscriptWorker: 'Worker',
    taskTranscriptTool: 'Tool',
