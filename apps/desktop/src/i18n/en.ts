...
export const en: Translations = {
  ...
  titlebar: {
    ...
    hideRightSidebar: 'Hide files sidebar',
    showRightSidebar: 'Show files sidebar',
  ...
  liveGraph: {
    ...
    title: 'Graph View',
    open: 'Open graph view',
    subtitle: (nodes, edges) => `${nodes} nodes · ${edges} connections`,
    searchPlaceholder: 'Search graph…',
    fit: 'Fit graph',
    arrows: 'Arrows',
    labels: 'Labels',
    nodeSize: 'Node size',
    textFadeThreshold: 'Text fade threshold',
    orphans: 'Orphans',
    ...
    animate: 'Animate',
    emptyTitle: 'This session is quiet',
    emptyDesc: 'Workflows, agents, and artifacts appear here as Hermes works.',
    loading: 'Loading session graph…',
    loadFailed: 'Could not load the session graph.',
    globalTitle: 'All workflows',
    globalEmptyTitle: 'No workflows yet',
    globalEmptyDesc: 'Workflows from your sessions will appear here as Hermes creates them.',
    globalLoading: 'Loading workflow graph…',
    globalLoadFailed: 'Could not load the workflow graph.',
    openSession: 'Open session',
    unattachedWorkflows: 'Unattached workflows',
    ...
    taskDetailLoadFailed: 'Could not load the latest task details.',
    taskCommentsEmpty: 'No comments yet.',
    taskCommentComposerLabel: 'Add a comment to this task',
    taskCommentPlaceholder: 'Add a comment…',
    taskCommentSubmit: 'Comment',
    taskCommentSubmitting: 'Posting…',
    taskCommentSubmitFailed: 'Could not post the comment. Try again.',
    taskActivityEmpty: 'No activity yet.',
    taskWorkerTranscriptLoading: 'Loading session activity…',
    taskWorkerTranscriptLoadFailed: 'Could not load the session activity.',
    taskWorkerTranscriptEmpty: 'No session activity is available.',
    taskRunHistory: 'Run history',
    unknownCommentAuthor: 'Anonymous',
    openTask: 'Open task',
    showMore: 'Show more',
    showLess: 'Show less',
    ...
    messagesEmpty: 'No task comments yet.',
    messagesLoadFailed: 'Could not load task messages.',
    messagesStale: 'Showing the last complete thread. Refresh failed.',
    ...
    pulseAnnouncement: (label, status) => `${label} is ${status}`
  },
  agents: {
    close: 'Close agents',
    title: 'Spawn tree',
