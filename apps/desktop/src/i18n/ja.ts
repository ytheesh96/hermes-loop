...
export const ja = defineLocale({
  ...
  titlebar: {
    ...
    hideRightSidebar: 'ファイルサイドバーを非表示',
    showRightSidebar: 'ファイルサイドバーを表示',
  ...
  liveGraph: {
    ...
    title: 'グラフビュー',
    open: 'グラフビューを開く',
    subtitle: (nodes, edges) => `${nodes} ノード · ${edges} 接続`,
    searchPlaceholder: 'グラフを検索…',
    fit: 'グラフを画面に合わせる',
    arrows: '矢印',
    labels: 'ラベル',
    nodeSize: 'ノードサイズ',
    textFadeThreshold: 'テキストのフェードしきい値',
    orphans: '孤立ノード',
    focusDepth: '表示範囲',
    depthOne: '1 ホップ',
    depthTwo: '2 ホップ',
    ...
    linkDistance: 'リンク距離',
    animate: 'アニメーション',
    emptyTitle: 'このセッションはまだ静かです',
    emptyDesc: 'Hermes が作業すると、ワークフロー、エージェント、成果物がここに表示されます。',
    loading: 'セッショングラフを読み込み中…',
    loadFailed: 'セッショングラフを読み込めませんでした。',
    globalTitle: 'すべてのワークフロー',
    globalEmptyTitle: 'ワークフローはまだありません',
    globalEmptyDesc: 'Hermes が作成した各セッションのワークフローがここに表示されます。',
    globalLoading: 'ワークフローグラフを読み込み中…',
    globalLoadFailed: 'ワークフローグラフを読み込めませんでした。',
    openSession: 'セッションを開く',
    unattachedWorkflows: '未接続のワークフロー',
    noMatches: '一致するノードはありません。',
    inspector: '選択項目',
    taskId: 'タスク ID',
    assignee: '担当者',
    priority: '優先度',
    ...
    taskViewDetails: '詳細',
    taskDetailLoading: 'タスクの詳細を読み込み中…',
    taskDetailLoadFailed: '最新のタスク詳細を読み込めませんでした。',
    taskCommentsEmpty: 'コメントはまだありません。',
    taskCommentComposerLabel: 'このタスクにコメントを追加',
    taskCommentPlaceholder: 'コメントを追加…',
    taskCommentSubmit: 'コメント',
    taskCommentSubmitting: '投稿中…',
    taskCommentSubmitFailed: 'コメントを投稿できませんでした。もう一度お試しください。',
    taskActivityEmpty: 'アクティビティはまだありません。',
    taskWorkerTranscriptLoading: 'セッションアクティビティを読み込み中…',
    taskWorkerTranscriptLoadFailed: 'セッションアクティビティを読み込めませんでした。',
    taskWorkerTranscriptEmpty: 'セッションアクティビティはありません。',
    taskRunHistory: '実行履歴',
    unknownCommentAuthor: '匿名',
    openTask: 'タスクを開く',
    showMore: 'もっと見る',
    showLess: '折りたたむ',
    ...
    messagesEmpty: 'タスクのコメントはまだありません。',
    messagesLoadFailed: 'タスクメッセージを読み込めませんでした。',
    messagesStale: '前回の完全なスレッドを表示しています。更新に失敗しました。',
    ...
    pulseAnnouncement: (label, status) => `${label}: ${status}`
  },
  agents: {
    close: 'エージェントを閉じる',
    title: 'スポーンツリー',
