...
export const ja = defineLocale({
  ...
  liveGraph: {
    ...
    taskWorkerTranscript: 'ワーカーの記録',
    taskWorkerTranscriptLoading: 'ワーカーの記録を読み込み中…',
    taskWorkerTranscriptLoadFailed: 'ワーカーの記録を読み込めませんでした。',
    taskWorkerTranscriptEmpty: 'ワーカーの記録はありません。',
    taskTranscriptUser: 'ユーザー',
    taskTranscriptWorker: 'ワーカー',
    taskTranscriptTool: 'ツール',
    taskRunHistory: '実行履歴',
