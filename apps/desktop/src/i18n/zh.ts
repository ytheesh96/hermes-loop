...
export const zh: Translations = {
  ...
  titlebar: {
    ...
    hideRightSidebar: '隐藏文件侧边栏',
    showRightSidebar: '显示文件侧边栏',
    muteHaptics: '关闭触感反馈',
  ...
  liveGraph: {
    ...
    title: '图谱视图',
    open: '打开图谱视图',
    subtitle: (nodes, edges) => `${nodes} 个节点 · ${edges} 条连接`,
    searchPlaceholder: '搜索图谱…',
    fit: '适配图谱',
    arrows: '箭头',
    labels: '标签',
    nodeSize: '节点大小',
    textFadeThreshold: '文本淡化阈值',
    orphans: '孤立节点',
    focusDepth: '聚焦深度',
    depthOne: '1 跳',
    depthTwo: '2 跳',
    ...
    animate: '动画',
    emptyTitle: '此会话暂时安静',
    emptyDesc: 'Hermes 工作时，工作流、智能体和产物会显示在这里。',
    loading: '正在加载会话图谱…',
    loadFailed: '无法加载会话图谱。',
    globalTitle: '所有工作流',
    globalEmptyTitle: '暂无工作流',
    globalEmptyDesc: 'Hermes 创建的各会话工作流会显示在这里。',
    globalLoading: '正在加载工作流图谱…',
    globalLoadFailed: '无法加载工作流图谱。',
    openSession: '打开会话',
    unattachedWorkflows: '未关联的工作流',
    noMatches: '没有匹配的节点。',
    inspector: '所选项',
    taskId: '任务 ID',
    assignee: '负责人',
    ...
    taskDetailLoadFailed: '无法加载最新任务详情。',
    taskCommentsEmpty: '暂无评论。',
    taskCommentComposerLabel: '为此任务添加评论',
    taskCommentPlaceholder: '添加评论…',
    taskCommentSubmit: '评论',
    taskCommentSubmitting: '正在发布…',
    taskCommentSubmitFailed: '无法发布评论，请重试。',
    taskActivityEmpty: '暂无活动。',
    taskWorkerTranscriptLoading: '正在加载会话活动…',
    taskWorkerTranscriptLoadFailed: '无法加载会话活动。',
    taskWorkerTranscriptEmpty: '暂无会话活动。',
    taskRunHistory: '运行历史',
    ...
    messagesEmpty: '暂无任务评论。',
    messagesLoadFailed: '无法加载任务消息。',
    messagesStale: '正在显示上次完整内容。刷新失败。',
  ...
  statusStack: {
    ...
    blockedTasks: count => `${count} 个受阻任务`,
    completedTasks: count => `${count} 个已完成任务`,
    loop: 'Loop',
    loopWorkers: count => `${count} 个 Kanban 代理`,
    pendingTasks: count => `${count} 个待处理任务`,
    newWorkflow: '新建工作流',
    openWorkflow: '打开工作流',
    goalActive: '目标进行中',
    goalDone: '目标已完成',
