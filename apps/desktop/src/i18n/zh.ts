...
export const zh: Translations = {
  ...
  liveGraph: {
    ...
    taskWorkerTranscript: '工作进程记录',
    taskWorkerTranscriptLoading: '正在加载工作进程记录…',
    taskWorkerTranscriptLoadFailed: '无法加载工作进程记录。',
    taskWorkerTranscriptEmpty: '暂无工作进程记录。',
    taskTranscriptUser: '用户',
    taskTranscriptWorker: '工作进程',
