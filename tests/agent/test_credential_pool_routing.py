...
class TestFailureAttribution:
    ...
    def _make_pool(self, tmp_path, monkeypatch, entries):
        # Anthropic pools also discover Claude Code credentials from HOME.
        # Isolate that singleton source so these fixtures contain exactly the
        # entries declared below, regardless of the developer machine running
        # the suite.
