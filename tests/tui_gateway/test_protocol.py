    ...
    resp = server.handle_request(
        {
            "id": "r1",
            "method": "session.resume",
            # eager_build: this regression checks the agent construction target;
            # default cold resumes are intentionally deferred.
            "params": {"session_id": "compressed-parent", "cols": 100, "eager_build": True},
        }
    )
