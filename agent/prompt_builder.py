...
KANBAN_FOREGROUND_GUIDANCE = (
    ...
    '`delegate_task(mode="loop", tasks=[...])` directly in the first model '
    "round. The built-in foreground contract is complete for this native Loop "
    "path, and the auto-decomposer owns specification, fan-out, and routing. "
    "Before the "
    "initial create or a sufficiently evidenced boundary mutation, do not load "
